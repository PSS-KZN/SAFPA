...
export default function SAFPADashboard() {
  ...
  const cards = [
    ...
    { label: 'Total Members', value: stats.totalMembers.toLocaleString(), sub: 'Current member book', icon: <Users size={24} className="text-white" />, gradient: 'from-blue-600 to-blue-800' },
    ...
    { label: 'Collection Rate', value: `${stats.collectionRate}%`, sub: `R${stats.premiumsCollectedThisMonth.toLocaleString()} collected`, icon: <Wallet size={24} className="text-white" />, gradient: 'from-amber-500 to-amber-600' },
    { label: 'Premiums Due', value: `R${stats.premiumsDueThisMonth.toLocaleString()}`, sub: 'This month', icon: <TrendingUp size={24} className="text-white" />, gradient: 'from-slate-700 to-slate-800' },
    { label: 'Total Arrears', value: `R${stats.totalArrears.toLocaleString()}`, sub: `${stats.openFuneralCases} open cases`, icon: <AlertTriangle size={24} className="text-white" />, gradient: 'from-red-600 to-red-800' },
  ];
